theory LRE_Beh_26122022_113308
...
zoperation OCMToMOM =
  over LRE_Beh
  pre "st= OCM \<and> (( * ) + ( * ))\<le>(3 * 3) \<and> dist(pos, Obsts)>10 \<and> \<not>inOPEZ(pos) \<and> trg=Some reqMOM"
...
zoperation MOMToHCM =
  over LRE_Beh
  pre "st= MOM \<and> (( * ) + ( * ))>(3 * 3) \<and> dist(pos, Obsts)\<le>StaticObsDist \<and> CDA(pos, Obsts, vel)>MinSafeDist \<and> \<not>inOPEZ(pos)"

theory Movement_24082022_114900
...
zoperation AvoidingAgainToAvoiding =
  over Movement
  params d0 \<in> "real" 
  pre "act_st= AvoidingAgain \<and> (clock<stuckPeriod \<or> (d1 - d0)>stuckDist) \<and> clock=0"
  update "[ act_st\<Zprime>= Avoiding
  		  , desired_st\<Zprime>= {TryingAgain, Found, Waiting}
          , event_odometer\<Zprime> = True
          , changeDirection(l)
...
zoperation AvoidingAgainToGettingOut =
  over Movement
  pre "act_st= AvoidingAgain \<and> clock\<ge>stuckPeriod \<and> (d1 - d0)\<le>stuckDist"
  update "[ act_st\<Zprime>= GettingOut
  		  , desired_st\<Zprime>= {Going, Found, Waiting}
          , shortRandomWalk()
          , clock\<Zprime> = clock + outPeriod
          ]"
...
lemma WaitingToGoing_inv: "WaitingToGoing (a) preserves Movement_inv"
  by (zpog_full; auto)
  
lemma GoingToGoing_inv: "GoingToGoing (a) preserves Movement_inv"
  by (zpog_full; auto)
...
lemma GoingToAvoiding_inv: "GoingToAvoiding (l, d0) preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingToTryingAgain_inv: "AvoidingToTryingAgain (a) preserves Movement_inv"
  by (zpog_full; auto)
  
lemma TryingAgainToTryingAgain_inv: "TryingAgainToTryingAgain (a) preserves Movement_inv"
  by (zpog_full; auto)
...
lemma TryingAgainToAvoidingAgain_inv: "TryingAgainToAvoidingAgain (l, d1) preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingAgainToAvoiding_inv: "AvoidingAgainToAvoiding (d0) preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingAgainToGettingOut_inv: "AvoidingAgainToGettingOut() preserves Movement_inv"
  by (zpog_full; auto)
  
lemma GettingOutToGoing_inv: "GettingOutToGoing (a) preserves Movement_inv"
  by (zpog_full; auto)

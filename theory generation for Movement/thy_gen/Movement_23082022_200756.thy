theory Movement_23082022_080756
...
zoperation WaitingToGoing =
  over Movement
  params a \<in> "Angle" 
  pre "act_st= Waiting \<and> event_turn"
...
zoperation GoingToGoing =
  over Movement
  params a \<in> "Angle" 
  pre "act_st= Going \<and> event_turn"
  update "[ act_st\<Zprime>= Going
  		  , desired_st\<Zprime>= {Going, Found, Avoiding, Waiting}
          , move(lv, a)
          ]"
...
zoperation AvoidingToTryingAgain =
  over Movement
  params a \<in> "Angle" 
  pre "act_st= Avoiding \<and> event_turn"
...
zoperation TryingAgainToTryingAgain =
  over Movement
  params a \<in> "Angle" 
  pre "act_st= TryingAgain \<and> event_turn"
  update "[ act_st\<Zprime>= TryingAgain
  		  , desired_st\<Zprime>= {TryingAgain, Found, Waiting, AvoidingAgain}
          , move(lv, a)
          ]"
...
zoperation TryingAgainToAvoidingAgain =
  ...
  pre "act_st= TryingAgain \<and> event_obstacle"
...
zoperation AvoidingAgainToAvoiding =
  over Movement
  params d0 \<in> "real" 
  pre "act_st= AvoidingAgain \<and> (<stuckPeriod \<or> (d1 - d0)>stuckDist)"
  update "[ act_st\<Zprime>= Avoiding
  		  , desired_st\<Zprime>= {TryingAgain, Found, Waiting}
          , event_odometer\<Zprime> = True
          , changeDirection(l)
...
zoperation AvoidingAgainToGettingOut =
  over Movement
  pre "act_st= AvoidingAgain \<and> \<ge>stuckPeriod \<and> (d1 - d0)\<le>stuckDist"
...
zoperation GettingOutToGoing =
  over Movement
  params a \<in> "Angle" 
  pre "act_st= GettingOut \<and> event_turn"
  update "[ act_st\<Zprime>= Going
  		  , desired_st\<Zprime>= {Going, Found, Avoiding, Waiting}
          , move(lv, a)
          ]"
...
lemma WaitingToGoing_inv: "WaitingToGoing EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma GoingToGoing_inv: "GoingToGoing EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
...
lemma GoingToAvoiding_inv: "GoingToAvoiding EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingToTryingAgain_inv: "AvoidingToTryingAgain EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma TryingAgainToTryingAgain_inv: "TryingAgainToTryingAgain EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
...
lemma TryingAgainToAvoidingAgain_inv: "TryingAgainToAvoidingAgain EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingAgainToAvoiding_inv: "AvoidingAgainToAvoiding EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingAgainToGettingOut_inv: "AvoidingAgainToGettingOut() preserves Movement_inv"
  by (zpog_full; auto)
  
lemma GettingOutToGoing_inv: "GettingOutToGoing EolOrderedSet [a, l, d0, d1] preserves Movement_inv"
  by (zpog_full; auto)

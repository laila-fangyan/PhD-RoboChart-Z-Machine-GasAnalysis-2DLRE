theory Movement_23082022_081117
...
lemma WaitingToGoing_inv: "WaitingToGoing EolOrderedSet [a] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma GoingToGoing_inv: "GoingToGoing EolOrderedSet [a] preserves Movement_inv"
  by (zpog_full; auto)
...
lemma GoingToAvoiding_inv: "GoingToAvoiding EolOrderedSet [l, d0] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingToTryingAgain_inv: "AvoidingToTryingAgain EolOrderedSet [a] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma TryingAgainToTryingAgain_inv: "TryingAgainToTryingAgain EolOrderedSet [a] preserves Movement_inv"
  by (zpog_full; auto)
...
lemma TryingAgainToAvoidingAgain_inv: "TryingAgainToAvoidingAgain EolOrderedSet [l, d1] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingAgainToAvoiding_inv: "AvoidingAgainToAvoiding EolOrderedSet [d0] preserves Movement_inv"
  by (zpog_full; auto)
  
lemma AvoidingAgainToGettingOut_inv: "AvoidingAgainToGettingOut() preserves Movement_inv"
  by (zpog_full; auto)
  
lemma GettingOutToGoing_inv: "GettingOutToGoing EolOrderedSet [a] preserves Movement_inv"
  by (zpog_full; auto)

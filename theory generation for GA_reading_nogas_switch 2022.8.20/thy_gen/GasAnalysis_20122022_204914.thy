theory GasAnalysis_20122022_084914
...
definition "St = {initial, NoGas, Analysis, GasDetected, final, Reading}" 


enumtype Evt = enumtype St = initial | NoGas | Analysis | GasDetected | final | Reading stop 
definition "Evt = {definition "St = {initial, NoGas, Analysis, GasDetected, final, Reading}"stop}" 
...
zoperation AnalysisToNoGas =
  ...
  update "[ st\<Zprime>= NoGas
       ,tr\\<Zprime> =tr @ @ [Event resume] @ NoGas
         ,trg\\<Zprime> = None
          ]"
...
zoperation GasDetectedToReading =
  ...
  update "[ st\<Zprime>= Reading
       ...
       ,tr\\<Zprime> =tr @ @ [Event turn] @ Reading
         ,trg\\<Zprime> = None
          ]"
...
zoperation ReadingToAnalysis =
  ...
  update "[ st\<Zprime>= Analysis
       ...
       ,tr\\<Zprime> =tr @ @ [Event gas] @ Analysis
         ,trg\\<Zprime> = None
          ]"
